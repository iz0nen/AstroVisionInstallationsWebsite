...
import { Hammer, Drill, Building2, PanelTop, RectangleHorizontal, Ruler, PanelsTopLeft, LayoutGrid, DoorOpen, Mail, Phone, CheckCircle, Upload, Menu, X, Images, Users, Home } from "lucide-react";
import "./style.css";
...
useEffect(() => {
  ...
  const services = [
    ...
    { title: "Casework Installation", icon: <RectangleHorizontal />, text: "Commercial casework, office cabinetry, built-ins, storage systems, cabinet & Countertop installations." },
