...
function AstroVisionWebsite() {
  ...
  const galleryImages = [
    { src: "/assets/Fixture half built.jpg", alt: "Fixture installation project" },
    { src: "/assets/retail-rollout-1.jpg", alt: "Retail rollout project" },
    { src: "/assets/retail-rollout-2.jpg", alt: "Retail rollout project" },
    { src: "/assets/Signage Display Walls 2.jpeg", alt: "Retail signage display wall" },
    { src: "/assets/Signage Display Walls.jpeg", alt: "Retail signage display wall" },
    { src: "/assets/skechers-work-wall.jpg", alt: "Skechers display wall" },
    { src: "/assets/workwear-display-wall.jpg", alt: "Workwear display wall" },
    { src: "/assets/cashwrap.jpg", alt: "Cashwrap installation" },
    { src: "/assets/slatwall-installation.jpg", alt: "Slatwall installation" },
    { src: "/assets/residential-cabinets.jpg", alt: "Cabinet installation" },
    { src: "/assets/nike-kids-finished-display.jpg", alt: "Nike completed display" },
    { src: "/assets/nike-kids-wall.jpg", alt: "Nike display wall" },
    { src: "/assets/retail-rollout-3.jpg", alt: "Retail rollout project" },
    ...
    <div className="site">
      <header className="header">
        <div className="nav-wrap">
          <a href="#home" className="brand brand-logo" onClick={() => goTo("home")}>
            <img src="/assets/astro-vision-header-logo.png" alt="Astro Vision Installations" />
          </a>

          <nav className="nav desktop-nav">
            <button className="nav-pill" onClick={() => goTo("home")}>Home</button>
            <button className="nav-pill" onClick={() => goTo("gallery")}>Project Gallery</button>
            <button className="nav-pill" onClick={() => goTo("join")}>Join Our Team</button>
            <button className="nav-pill nav-pill-primary" onClick={() => setQuoteOpen(true)}>Request a Quote</button>
          </nav>
        ...
        <main id="home">
          <section className="hero">
            ...
            <div className="hero-inner">
              ...
              <div className="actions">
                ...
                <button onClick={() => goTo("gallery")} className="btn secondary">View Project Gallery</button>
              </div>
            </div>
          </section>
          ...
          <section className="team-showcase">
            <div className="field-experience-header">
              ...
              <p>We focus on quality workmanship, safety, efficiency, and attention to detail from project start to completion.</p>
            </div>
          ...
          <section className="section cta">
            <div className="cta-box">
              ...
              <p>Request a quote with plans, contracting opportunities, ideas, and the vision of what you want/expect. We will respond back with a fair and concise offer that factors in everything. Astro Vision Installations has the experience and craftsmanship to bring your project to completion.</p>
              <div className="actions">
                <button onClick={() => setQuoteOpen(true)} className="btn">Request a Quote</button>
          ...
          <section className="section join-section">
            <div className="two-col join-layout">
              <div>
                ...
                <p className="join-copy">Complete the application below and your information will be sent directly to Astro Vision Installations for review.</p>
                <div className="join-highlights">
                  <div><CheckCircle /> Commercial project experience preferred</div>
                  <div><CheckCircle /> Dependability and attention to detail required</div>
                  <div><CheckCircle /> Travel availability is a plus</div>
                  <div><CheckCircle /> Tools and transportation preferred</div>
                </div>
              </div>
              <form className="application-form" onSubmit={async (event) => {
                ...
                if (response.ok) { alert("Thank you. Your application has been sent."); form.reset(); }
                else { alert("Something went wrong. Please email astrovisioninstallations@gmail.com."); }
              }}>
      ...
      <footer id="contact" className="footer">
        ...
        <div className="contact">
          <a href="tel:4078109979"><Phone /> (407) 810-9979</a>
        ...
        <div className="modal">
          <div className="modal-box">
            <div className="modal-head">
              <div><p className="eyebrow">Request a Quote</p><h2>Project Questionnaire</h2><p>Submit project details for review and quoting.</p></div>
              <button onClick={() => setQuoteOpen(false)}><X /></button>
            </div>
            <form className="quote-form" onSubmit={async (event) => {
              ...
              <label className="upload"><Upload /> Upload Plans, Drawings, Photos, or Scope Documents<input type="file" name="files" multiple /></label>
              <button className="btn">Submit Request</button><small>Form destination: astrovisioninstallations@gmail.com</small>
            </form>
          </div>
        </div>
      )}
