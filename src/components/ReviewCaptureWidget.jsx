...
const DEFAULT_SAAS_CONFIG = {
  ...
  logoUrl: "https://github.com/iz0nen/AstroVisionInstallationsWebsite/blob/main/public/assets/astro-vision-header-logo.png?raw=true", // Replace with actual hosted client graphic
